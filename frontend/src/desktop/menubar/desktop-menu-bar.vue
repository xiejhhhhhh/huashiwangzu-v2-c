<template>
  <header ref="menuBarRef" class="mac-menu-bar" aria-label="系统菜单栏" @mousedown.stop>
    ...
    <div v-if="openMenu" ref="popoverRef" class="mac-menu-popover" :class="`mac-menu-popover-${openMenu}`" role="menu" @keydown="handlePopoverKeydown">
