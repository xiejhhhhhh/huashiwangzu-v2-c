...
.launchpad-search{width:min(260px,100%);height:30px;display:flex;align-items:center;gap:7px;padding:0 10px;margin-bottom:38px;border:1px solid rgba(255,255,255,.28);border-radius:10px;background:rgba(255,255,255,.16);box-shadow:inset 0 1px 0 rgba(255,255,255,.2),0 8px 24px rgba(0,0,0,.12);backdrop-filter:var(--desktop-lg-filter-soft,blur(24px) saturate(160%));-webkit-backdrop-filter:var(--desktop-lg-filter-soft,blur(24px) saturate(160%))}.launcher-search-input{min-width:0;flex:1;border:0;outline:0;background:transparent;color:white;font:var(--desktop-font-body)}.launcher-search-input::placeholder{color:rgba(255,255,255,.72)}
