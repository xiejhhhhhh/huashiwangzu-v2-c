...
class TestDiminishingBudgetTracker:
    ...
    def test_get_diagnosis(self):
        tracker = DiminishingBudgetTracker()
        tracker.record_round("test_6", tokens_before=0, tokens_after=1000)
        tracker.record_round("test_6", tokens_before=1000, tokens_after=1500)
        diag = tracker.get_diagnosis("test_6")
