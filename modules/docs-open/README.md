...
|---|---|---|
| Manifest contract | PASS | `modules/docs-open/manifest.json` |
| Capability drift | PASS | `capability_contract_diff(module="docs-open", include_parameters=true)` |
| Backend sandbox | PASS | `PYTHONPATH=backend backend/.venv/bin/python modules/docs-open/sandbox/test_module.py` |
